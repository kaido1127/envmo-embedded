...
esp_err_t mq2_init()
{
    ...
    esp_err_t error_2 = adc1_config_channel_atten(ADC1_CHANNEL_6, ADC_ATTEN_DB_11); //cấu hình độ suy giảm của kênh ADC kênh 0 được cấu hình với độ suy giảm 11 dB chỉnh khoảng điện áp đầu vào của ADC để phù hợp với tín hiệu đầu vào.
